    ...
    <div className="flex flex-col h-[500px] w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-3xl">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-700 p-4 flex items-center justify-between text-white">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-sm leading-tight">{recipientName || "Customer"}</h3>
      ...
      <form onSubmit={sendMessage} className="p-4 bg-white border-t border-gray-100 flex items-center space-x-3">
        <input
          type="text"
          className="flex-1 bg-gray-100 border-none rounded-full py-2.5 px-4 text-sm focus:ring-2 focus:ring-emerald-500 transition-all outline-none"
        ...
        <button
          ...
          className="bg-emerald-600 text-white p-2.5 rounded-full hover:bg-emerald-700 disabled:opacity-50 transition-all shadow-lg"
        >
